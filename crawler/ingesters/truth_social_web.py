"""
Truth Social public timeline scraping using Playwright.
Only visible metadata is collected.
"""
...
def fetch_truth_public_timeline(handle: str, limit: int = 8, polite_delay: float = 2.0) -> List[SocialPostItem]:
    ...
    with sync_playwright() as p:
        ...
        for card in cards[:limit]:
            link = card.locator("a[href*='/post/']").first
